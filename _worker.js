...
// Variables
const rootDomain = "kasyi.my.id"; // Ganti dengan domain utama kalian
const serviceName = "kasyi"; // Ganti dengan nama workers kalian
const apiKey = "nuitD8fFN2tkZeKaVs2NcAPvcWdWQUMc_OnxTtl6"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "kasyiardian1@gmail.com"; // Ganti dengan email yang kalian gunakan
const accountID = "eb7ef171c8bdd8594221163c1d36f0cf"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
const zoneID = "50e9cf8f040b48ff40c7cf13dc90016d"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
